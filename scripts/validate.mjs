...
const checks = {
  ...
  hasBackendUserSystem: ["backendPanel", "authEmail", "authPassword", "auth-login", "auth-register", "auth-sync", "auth-logout"].every(token => html.includes(token)) && ["const apiState", "async function detectBackend", "async function authenticate", "function persistWorkspace", "function applyWorkspace"].every(token => app.includes(token)),
